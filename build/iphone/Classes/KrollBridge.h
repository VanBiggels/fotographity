...
@interface fotographityObject : KrollCoverageObject {
#else
@interface fotographityObject : KrollObject {
#endif
@private
...
extern NSString * fotographity$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	fotographityObject *_fotographity;
	BOOL shutdown;
