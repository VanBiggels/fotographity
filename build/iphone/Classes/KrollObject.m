 ...
 * Copyright (c) 2009-2011 by fotographity, Inc. All Rights Reserved.
...
//@interface fotographityObject : NSObject
//@end

@interface fotographityObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[fotographityObject class]])
		{
			for (NSString *key in [[(fotographityObject*)o modules] allKeys])
			{
