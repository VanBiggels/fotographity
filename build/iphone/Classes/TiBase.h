...
// in simulator we redefine to format for fotographity Developer console
...
{\
	NSString * exceptionName = [@"org.fotographity." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.fotographity";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIfotographityNativeItemNone = -1, 
	UIfotographityNativeItemSpinner = -2,
	UIfotographityNativeItemProgressBar = -3,
	
	UIfotographityNativeItemSlider = -4,
	UIfotographityNativeItemSwitch = -5,
	UIfotographityNativeItemMultiButton = -6,
	UIfotographityNativeItemSegmented = -7,
	
	UIfotographityNativeItemTextView = -8,
	UIfotographityNativeItemTextField = -9,
	UIfotographityNativeItemSearchBar = -10,
	
	UIfotographityNativeItemPicker = -11,
	UIfotographityNativeItemDatePicker = -12,
	
	UIfotographityNativeItemInfoLight = -13,
	UIfotographityNativeItemInfoDark = -14,
	
	UIfotographityNativeItemDisclosure = -15,
	
	UIfotographityNativeItemContactAdd = -16
};
